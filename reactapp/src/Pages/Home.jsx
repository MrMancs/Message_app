    ...
    return(
        <div className="flex flex-col justify-center text-center bg-linear-to-r from-red-200 to-orange-200">
            ...
            <Stack spacing={2} className="flex flex-col items-center justify-center h-screen">
                <Button onClick={() => navigate("/login")} variant="outlined" size="large" style={{color: "gray", borderColor: "gray"}}>Login</Button>
                <Button onClick={() => navigate("/register")} variant="outlined" size="large" style={{color: "gray", borderColor: "gray"}}>Register</Button>
            </Stack>
        </div>
    )
}